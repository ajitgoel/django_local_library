...
class Book(models.Model):
    ...
    def __str__(self):
        ...
        return self.title
    #get_absolute_url() returns a URL that can be used to access a detail record for this model (for this to work we will have to define a URL mapping that has the name 
...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ['due_back']
        #permission name and permission display value.
