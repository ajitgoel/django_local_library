...
""" class AuthorCreateTest(TestCase):
    ...
    def test_pagination_is_ten(self):
        ...
        self.assertEquals(len(response.context['author_list']), 10)
    #does not work
...
class RenewBookInstancesViewTest(TestCase):
    ...
    #we are able to access the value of the initial value of the form field using 
    #we are able to access the value of the initial value of the form field 
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        #The post data is the second argument to the post function, and is specified as a 
